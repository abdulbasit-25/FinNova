...
export function AppLayout() {
  ...
  return (
    <div className="flex min-h-screen w-full flex-col lg:flex-row bg-background overflow-hidden">
      ...
      {/* Main Content Area */}
      <main className={`flex-1 overflow-x-hidden overflow-y-auto ${contentPadding} ${sidebarWidth}`}>
        <div className={`mx-auto w-full max-w-7xl px-2 py-3 sm:px-4 md:py-4 lg:px-6`}>
          <Outlet />
        </div>
      </main>
